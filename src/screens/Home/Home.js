...
export default function ({ navigation }) {
  ...
  const tutorialSteps = [
    ...
    },
    {
      ...
      length: 25,  // Length of the arrow
      left: "3%",
      status: 16,
    },
    {
      title: 'Find a meal!',
      content: '• Explore upcoming meetups.\n• Connect with new friends.\n',
      left: "23%",
      status: 32,
    },
    {
      title: 'Host a meal!',
      content: '• Organize meetups that are available to\n   everyone.\n• Invite specific people to meetups.\n',
      left: "43%",
      status: 48,
    },
    {
      title: 'Messages!',
      content: '• Find notifications (e.g. about invited \n   meetups).\n• Find messages from friends!\n',
      left: "63%",
      status: 64,
    },
    {
      ...
      {userInfo && /*!userInfo.tutorial && */ tabsTutorial && // NOTE: set "userInfo.tutorial" to "!userInfo.tutorial" to see the tutorial
        <>
          <TutorialMessage
            ...
            status={tutorialSteps[step].status}
