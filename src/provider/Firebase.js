...
const firebaseConfig = {
    ...
    databaseURL: process.env.FIREBASE_DATABASE_URL ? process.env.FIREBASE_DATABASE_URL : FIREBASE_DATABASE_URL,
    ...
    appId: process.env.FIREBASE_APP_ID ? process.env.FIREBASE_APP_ID : FIREBASE_APP_ID,
};
